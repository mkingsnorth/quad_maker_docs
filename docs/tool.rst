...
* **Draw Quad Strips:**
    ...
    * **Strip Mode / Ring Mode:** Select whether Draw Quad Strip uses :ref:`standard Strip mode or Ring mode<ring_mode>`.  Can also be toggled with ``Tab`` while the operation is active.
